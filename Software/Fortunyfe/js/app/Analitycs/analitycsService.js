HISAnalitycs.factory('analitycsService',['$resource','$q','$http','connStringSVC',function($resource,$q,$http,connStringSVC){

return{
	report:function(){
			return $resource(connStringSVC.urlBase() + '/Report/:id', { id: '@_id' }, {
		...
		listPhotos:function(){
			return $resource(connStringSVC.urlBase() + '/ListPhotos/:id', { id: '@_id' }, {
